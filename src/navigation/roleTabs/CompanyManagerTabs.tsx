...
import { ClipboardList, Package, ArrowLeftRight, Menu as MenuIcon } from "lucide-react-native";
...
import { OutsourceImportScreen } from "../../features/outsourcing/OutsourceImportScreen";
import { MenuNavigator } from "../MenuNavigator";
import { sharedTabScreenOptions } from "../tabBarOptions";

const Tab = createBottomTabNavigator();

export function CompanyManagerTabs() {
  return (
    <Tab.Navigator screenOptions={sharedTabScreenOptions}>
      ...
      >
        {() => <ManagerOrdersNavigator dashboardTitle="Orders Dashboard" canCreateOrders />}
      </Tab.Screen>
      <Tab.Screen
        name="RawMaterials"
      ...
      />
      <Tab.Screen
        name="OutsourceImport"
        component={OutsourceImportScreen}
        options={{
          title: "Outsource / Import",
